...
const routes = [
  ...
  },
  {
    ...
    description: "Spider Energy provides EV charging station installation in Andhra Pradesh & Telangana with EPC services, construction support & infrastructure solutions for commercial and public spaces.",
